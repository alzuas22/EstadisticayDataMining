...
18. Rellenar los Square.Meters con valor NA con el estimado con el modelo anterior.
    ...
    ```{r}
    Este ejercicio lo he intentado hacer después de unas semanas, en su momento me salió y ahora no lo consigo, al volverlo a ejecutar me ha saltado un error y no consigo solucionarlo. El ejercicio de abajo (19) lo hice a continuación de este en su momento. 
    ```
